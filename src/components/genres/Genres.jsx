...
const Genres = () => {
    ...
    const {data, isError, isLoading} = useGetMovieDiscoverQuery({ with_genres: selectedGenre.join(","), without_genres: "10749"})
    ...
    return (
        <div className="bg-black text-white min-h-screen">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">{t('genres')}</h2>
