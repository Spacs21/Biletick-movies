...
const Movies = () => {
    ...
    const { data, isLoading, isError } = useGetMovieQuery({ type: "popular", params: ({ page: 2 }), include_adult: false })
    ...
    if (isError) {
        return <div className="text-center mt-11">
            <h2 className="text-2xl font-bold text-red-500">Error loading movies</h2>
        </div>
    }
